angular.module('app.controllers', ['ionic', 'ngCordova', 'ngCordovaOauth'])
...
.controller('LoginwithSocial', function ($state, $scope, $cordovaOauth) {

    $scope.facebook_button = function(){
